...
const Map<String, Map<String, String>> _strings = {
  'en': {
    ...
    'connectionFailed': 'Could not start the conversation. Try again.',
    'previewMode': 'GLOBOVERSE PREVIEW',
    'previewModeBody':
        'You are chatting with GloboGuide. Messages stay on this device.',
    'noMessages': 'Start with a friendly hello',
    ...
    'messageFailed': 'Message not sent. Tap to retry.',
    'messageSent': 'Sent',
    'messageDelivered': 'Delivered',
    'messageRead': 'Read',
    'report': 'Report',
    'reportTitle': 'Report this conversation?',
    'reportBody': 'Choose the reason that best describes the problem.',
    'reportHarassment': 'Harassment or bullying',
    'reportSpam': 'Spam or scam',
    'reportUnsafe': 'Unsafe or inappropriate content',
    'reportOther': 'Something else',
    'reportSubmitted':
        'Report submitted. Thank you for helping keep GloboVerse safe.',
    'reportFailed': 'Could not submit the report. Please try again.',
    'previewReportNoted': 'Preview feedback noted on this device.',
  ...
  'tg': {
    ...
    'connectingNow': 'Пайвастшавӣ…',
    'reconnecting': 'ДУБОРА ПАЙВАСТ',
    'connectionFailed': 'Суҳбат оғоз нашуд. Аз нав кӯшиш кунед.',
    'previewMode': 'НАМОИШИ GLOBOVERSE',
    'previewModeBody':
        'Шумо бо GloboGuide суҳбат доред. Паёмҳо дар ҳамин дастгоҳ мемонанд.',
    'noMessages': 'Суҳбатро бо салом оғоз кунед',
    'messageHint': 'Паём нависед…',
    'sendMessage': 'Фиристодани паём',
    'showTranslations': 'Нишон додани тарҷума',
    'hideTranslations': 'Пинҳон кардани тарҷума',
    'originalMessage': 'МАТНИ АСЛӢ',
    'translatedMessage': 'ТАРҶУМА',
    'messageFailed': 'Паём фиристода нашуд. Барои такрор зер кунед.',
    'messageSent': 'Фиристода шуд',
    'messageDelivered': 'Расид',
    'messageRead': 'Хонда шуд',
    'report': 'Шикоят',
    'reportTitle': 'Аз ин суҳбат шикоят мекунед?',
    'reportBody': 'Сабаби мувофиқро интихоб кунед.',
    'reportHarassment': 'Озору таҳқир',
    'reportSpam': 'Спам ё қаллобӣ',
    'reportUnsafe': 'Муҳтавои номуносиб ё хатарнок',
    'reportOther': 'Сабаби дигар',
    'reportSubmitted':
        'Шикоят фиристода шуд. Барои бехатарии GloboVerse ташаккур.',
    'reportFailed': 'Шикоят фиристода нашуд. Лутфан, боз кӯшиш кунед.',
    'previewReportNoted': 'Назари намоишӣ дар ҳамин дастгоҳ қайд шуд.',
    'trySaying': 'Пешниҳод',
    'account': 'Ҳисоб',
  ...
  'ru': {
    ...
    'connectingNow': 'Подключение…',
    'reconnecting': 'ПОВТОРНОЕ ПОДКЛЮЧЕНИЕ',
    'connectionFailed': 'Не удалось начать разговор. Попробуйте ещё раз.',
    'previewMode': 'ДЕМО GLOBOVERSE',
    'previewModeBody':
        'Вы общаетесь с GloboGuide. Сообщения остаются на этом устройстве.',
    'noMessages': 'Начните с дружеского приветствия',
    ...
    'messageFailed': 'Сообщение не отправлено. Нажмите, чтобы повторить.',
    'messageSent': 'Отправлено',
    'messageDelivered': 'Доставлено',
    'messageRead': 'Прочитано',
    'report': 'Пожаловаться',
    'reportTitle': 'Пожаловаться на разговор?',
    'reportBody': 'Выберите причину, которая лучше всего описывает проблему.',
    'reportHarassment': 'Оскорбления или травля',
    'reportSpam': 'Спам или мошенничество',
    'reportUnsafe': 'Опасный или недопустимый контент',
    'reportOther': 'Другая причина',
    'reportSubmitted':
        'Жалоба отправлена. Спасибо, что помогаете сохранять безопасность.',
    'reportFailed': 'Не удалось отправить жалобу. Попробуйте ещё раз.',
    'previewReportNoted': 'Отзыв о деморежиме отмечен на этом устройстве.',
    'trySaying': 'Попробуйте написать',
  ...
  'uz': {
    ...
    'connectingNow': 'Ulanmoqda…',
    'reconnecting': 'QAYTA ULANMOQDA',
    'connectionFailed': 'Suhbatni boshlab bo‘lmadi. Qayta urinib ko‘ring.',
    'previewMode': 'GLOBOVERSE NAMOYISHI',
    'previewModeBody':
        'Siz GloboGuide bilan suhbatlashyapsiz. Xabarlar shu qurilmada qoladi.',
    'noMessages': 'Do‘stona salom bilan boshlang',
    'messageHint': 'Xabar yozing…',
    'sendMessage': 'Xabar yuborish',
    'showTranslations': 'Tarjimani ko‘rsatish',
    'hideTranslations': 'Tarjimani yashirish',
    'originalMessage': 'ASL MATN',
    'translatedMessage': 'TARJIMA',
    'messageFailed': 'Xabar yuborilmadi. Takrorlash uchun bosing.',
    'messageSent': 'Yuborildi',
    'messageDelivered': 'Yetkazildi',
    'messageRead': 'O‘qildi',
    'report': 'Shikoyat',
    'reportTitle': 'Bu suhbat haqida shikoyat qilasizmi?',
    'reportBody': 'Muammoni eng yaxshi ifodalovchi sababni tanlang.',
    'reportHarassment': 'Haqorat yoki ta’qib',
    'reportSpam': 'Spam yoki firibgarlik',
    'reportUnsafe': 'Xavfli yoki nomaqbul kontent',
    'reportOther': 'Boshqa sabab',
    'reportSubmitted':
        'Shikoyat yuborildi. GloboVerse xavfsizligiga yordam berganingiz uchun rahmat.',
    'reportFailed': 'Shikoyat yuborilmadi. Qayta urinib ko‘ring.',
    'previewReportNoted': 'Sinov rejimi fikri shu qurilmada qayd etildi.',
    'trySaying': 'Sinab ko‘ring',
